...
public class CustomerEndPoints {
	...
	public static Response customer_GetBookingEndPoint(ITestContext context, String status) {
		...
		Response response = given().header("Authorization", "Bearer " + token).contentType(ContentType.JSON).queryParam("status",status).when().get(Routes.customer_GetBookingURL);
